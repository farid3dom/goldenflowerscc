...
import '../Grunt/style.scss';

//Import Images
import GruntBG from '../../../assets/media/images/materials/gold_plants.jpg';
...
//Import Utils
import GruntJSON from '../../../utils/grunt.json';
...
const Index = () => {
    ...
    useEffect(() => {
        function getSearchedData() {
            ...
            if (searchValue) {
                setTimeout(() => {
                    let searchedValue = GruntJSON.filter(f => f.name[lang].toLowerCase().includes(searchValue.toLowerCase()))
    ...
    const searchSubmit = (e) => {
        e.preventDefault();
        searchInputValue ?
            navigate(`/plants/grunt?search=${searchInputValue}`)
            :
            navigate('/plants/grunt');

        // setSearchInputValue('');
    }

    return (
        <div className="grunt_page_container">
            ...
            <div className="grunt_content_wrapper">
                <div className="content_wrapper_inner">
                    ...
                    <div className="grunt_gallery gallery_grid_wrapper">
                        {galleryLoading &&
