            ...
            <div className="scroller_container">
                ...
                <div className="scroller_departments">
                    ...
                    <div className="scroll_flowers scroll_parts">
                        ...
                        <div className="tag-list_1 scroller_inner">
                            <div loop={0} class="scroll_img marquee">
                    ...
                    <div className="scroll_plants scroll_parts">
                        <div className="tag-list_2 scroller_inner">
                            <div class="scroll_img_plants marquee">
                    ...
                    <div className="scroll_accessories scroll_parts">
                        ...
                        <div className="tag-list_3 scroller_inner">
                            <div class="scroll_img marquee">
